...
export const metadata: Metadata = {
  title: "Zhang Chao | Architect & Designer",
  description: "A digital garden of thoughts and stories about design, architecture, and code.",
};
        ...
        >
          <div className="flex flex-col min-h-screen">
            ...
            <footer className="py-6 text-center text-sm text-gray-500 border-t border-gray-100 dark:border-gray-800">
              © {new Date().getFullYear()} Zhang Chao. All rights reserved.
            </footer>
          </div>
        </ThemeProvider>
      </body>
